...
<div class="w3-container w3-padding">
    ...
    <div class="w3-card-4">
        <div class="w3-container w3-center w3-lime">
            <h2 class="w3-text-pink">Delete an existing order!!!</h2>
            <h2 class="w3-text-black">Enter order's ID to delete the order</h2>
        </div>
...
<div class="w3-container w3-grey w3-opacity w3-right-align w3-padding">
    <button class="w3-btn w3-round-large" onclick="location.href='/ordersMenu.html'">Back to product menu</button>
